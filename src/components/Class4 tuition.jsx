...
export default function Class4tuition() {
  ...
  return (
    <div className="class12 p-4">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6">
        Enrol For Online Tuition For Class 4 To Ace Board Exams 
      </h2>
      ...
      <div className="container mx-auto px-4">
        ...
        <Link
  className="inline-block bg-slate-500 text-white text-l font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-200"
  to="/bookonlinedemo"
>
  Book Online Demo
</Link>
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-center my-6">
        Master All Subjects with Online Tuition for Class 4 </h2>

      <table className="w-full table-auto border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-200">
            <th className="border border-gray-300 px-4 py-2">S.No.</th>
            <th className="border border-gray-300 px-4 py-2">Subject wise Tuition for Class 4</th>
          </tr>
        </thead>
        <tbody>
          <tr>
  ...
  {/* Class 4 Subjects Dropdown */}
  <div className="mb-4">
    <label htmlFor="subject" className="block text-gray-700 text-sm font-bold mb-2">Select Subject</label>
    <select 
      id="subject" 
      className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline"
    >
      <option>Mathematics</option>
      <option>EVS (Environmental Studies)</option>
      <option>English</option>
      <option>Hindi</option>
      <option>Computer Science</option>
      <option>Sanskriti</option>
