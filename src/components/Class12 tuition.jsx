...
export default function Class12tuition() {
  return (
    <div className='class12'>
      <h2 className='class12h2'>Enrol For Online Tuition For Class 12 To Ace Board Exams</h2>
    ...
    <div className="collapse navbar-collapse" id="navbarNavDropdown">
      <ul className="navbar-nav">
        <li className="nav-item dropdown">
          ...
          <li><Link className="dropdown-item" to="">Class 12 Tuition</Link></li>
...
<h2>Master All Subject with Online Tuition for Class 12</h2>
<table className='class12table' >
            <thead>
                <tbody>
                    <tr>
                        <th>S.No.</th>
                        <th>Subject wise Tuition for Class  12</th>
                    </tr>
                    <tr>
                        <td>1</td>
