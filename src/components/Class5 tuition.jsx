...
export default function Class5tuition() {
  ...
  return (
    <div className="class12 p-4">
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-center my-6">
        Master All Subjects with Online Tuition for Class 5 </h2>

      <table className="w-full table-auto border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-200">
            <th className="border border-gray-300 px-4 py-2">S.No.</th>
            <th className="border border-gray-300 px-4 py-2">Subject wise Tuition for Class 5</th>
          </tr>
        </thead>
        <tbody>
          <tr>
