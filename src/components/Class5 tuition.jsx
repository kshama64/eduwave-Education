...
export default function Class5tuition() {
  return (
    ...
    <h2 className='class12h2'>Enrol For Online Tuition For Class 5 To Ace Board Exams</h2>
...
<h2>Master All Subject with Online Tuition for Class 5</h2>
<table className='class12table' >
          <thead>
              <tbody>
                  <tr>
                      <th>S.No.</th>
                      <th>Subject wise Tuition for Class  5</th>
                  </tr>
                  <tr>
                      <td>1</td>
