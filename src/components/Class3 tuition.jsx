...
export default function Class3tuition() {
  return (
    ...
    <h2 className='class12h2'>Enrol For Online Tuition For Class 3 To Ace Board Exams</h2>
    ...
    <ul className="navbar-nav">
      ...
      <li className="nav-item dropdown">
        ...
        <li><Link className="dropdown-item" to="/class12">Class 12 Tuition</Link></li>
          ...
          <li><Link className="dropdown-item" to="">Class 3 Tuition</Link></li>
        </ul>
      </li>
      <li className="nav-item dropdown">
...
<h2>Master All Subject with Online Tuition for Class 3</h2>
<table className='class12table' >
          <thead>
              <tbody>
                  <tr>
                      <th>S.No.</th>
                      <th>Subject wise Tuition for Class  3</th>
                  </tr>
                  <tr>
                      <td>1</td>
