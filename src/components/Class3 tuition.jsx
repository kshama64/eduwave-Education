...
export default function Class3tuition() {
  ...
  return (
    <div className="class12 p-4">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6">
        Enrol For Online Tuition For Class 3 To Ace Board Exams 
      </h2>
  ...
  <div className="container mx-auto px-4">
    ...
    <div className={`${isMenuOpen ? 'block' : 'hidden'} lg:hidden`}>
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-center my-6">
        Master All Subjects with Online Tuition for Class 3 </h2>

      <table className="w-full table-auto border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-200">
            <th className="border border-gray-300 px-4 py-2">S.No.</th>
            <th className="border border-gray-300 px-4 py-2">Subject wise Tuition for Class 3</th>
          </tr>
        </thead>
        <tbody>
          <tr>
