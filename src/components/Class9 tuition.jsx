...
export default function Class9tuition() {
  ...
  return (
    <div className="class12 p-4">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6">
        Enrol For Online Tuition For Class 9 To Ace Board Exams 
      </h2>
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-center my-6">
        Master All Subjects with Online Tuition for Class 9 </h2>

      <table className="w-full table-auto border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-200">
            <th className="border border-gray-300 px-4 py-2">S.No.</th>
            <th className="border border-gray-300 px-4 py-2">Subject wise Tuition for Class 9</th>
          </tr>
        </thead>
        <tbody>
          <tr>
  ...
  <div className="mb-4">
    ...
    <select id="subject" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
      ...
      <optgroup label="Class 9 Subjects">
      <option value="mathematics-10">Mathematics</option>
        ...
        {/* Add more subjects for Class 9 if needed */}
      </optgroup>
    </select>
  </div>
